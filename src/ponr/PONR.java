...
public class PONR {
    ...
    /**
     *Evalua todas las restricciones de igualdad
     * @param ind
     * @return suma de violación de restricciones
     */
    protected double evaluarRestriccionesI(double[] ind) {
        return ind[0];
    }
    ...
    /**
     * Método que asigna true si la variable es discreta, caso contrario, es
     * false.
     *
